...
CREATE TABLE `blackmarket_auctions` ( `auctionId` INT(10) UNSIGNED NOT NULL DEFAULT '0', `templateId` INT(10) UNSIGNED NOT NULL DEFAULT '0', `startTime` INT(10) UNSIGNED NOT NULL DEFAULT '0', `currentBidder` INT(10) UNSIGNED NOT NULL DEFAULT '0', `currentBid` INT(10) UNSIGNED NOT NULL DEFAULT '0', `minIncrement` INT(10) UNSIGNED NOT NULL DEFAULT '0', `numBids` INT(10) UNSIGNED NOT NULL DEFAULT '0')
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=63954
...
SELECT id, entry, owner, modelid, level, exp, Reactstate, slot, name, renamed, curhealth, curmana, abdata, savetime, CreatedBySpell, PetType FROM character_pet WHERE owner = ? AND slot = ?
...
CREATE TABLE `character_currency` ( `guid` int(10) unsigned NOT NULL, `currency` smallint(5) unsigned NOT NULL, `total_count` int(10) unsigned NOT NULL, `week_count` int(10) unsigned NOT NULL, `season_count` int(10) unsigned NOT NULL, `flags` int(5) unsigned NOT NULL, PRIMARY KEY (`guid`,`currency`))
...
UPDATE creature_template SET faction_A=58, faction_H=58, unit_class=1  WHERE entry=2523
...
CREATE TABLE `research_digsite_data` ( `digsiteId` int(11) NOT NULL, `branchId` tinyint(3) NOT NULL, `requiredSkillValue` int(11) NOT NULL DEFAULT '0', `requiredLevel` int(11) NOT NULL DEFAULT '0', PRIMARY KEY (`digsiteId`))
...
CREATE TABLE `creature_classlevelstats` (	`level` TINYINT(4) NOT NULL,	`class` TINYINT(4) NOT NULL,	`OldContentBaseHP` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '1',	`CurrentContentBaseHP` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '1',	`basemana` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '1',	`basearmor` MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '1',	PRIMARY KEY (`level`, `class`))
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=73352
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =41435
...
UPDATE character_currency SET week_count = ?, total_count = ?, season_count = ?, flags = ?  WHERE guid = ? AND currency = ?
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=71201
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=43800
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=71159
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=67319
...
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =45558
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=70259
...
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =12246
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =19536
CREATE TABLE `character_research_digsites` ( `guid` int(11) NOT NULL COMMENT 'Global Unique Identifier', `digsiteId` int(11) NOT NULL, `currentFindGUID` int(11) NOT NULL DEFAULT '0', `remainingFindCount` tinyint(3) NOT NULL DEFAULT '0', PRIMARY KEY (`guid`, `digsiteId`))
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =1307
...
CREATE TABLE `character_research_history` ( `guid` int(11) NOT NULL COMMENT 'Global Unique Identifier', `projectId` int(11) NOT NULL, `researchCount` int(11) NOT NULL, `firstResearchTimestamp` int(11) NOT NULL, PRIMARY KEY (`guid`,`projectId`))
...
CREATE TABLE `ticket_bug` ( `ticketId` int(10) unsigned NOT NULL, `playerGuid` bigint(20) unsigned NOT NULL, `bugNote` text NOT NULL, `ticketCreateTime` int(10) unsigned NOT NULL DEFAULT '0', `mapId` smallint(5) unsigned NOT NULL DEFAULT '0', `posX` float NOT NULL DEFAULT '0', `posY` float NOT NULL DEFAULT '0', `posZ` float NOT NULL DEFAULT '0', `orientation` float NOT NULL DEFAULT '0', `closedBy` bigint(20) NOT NULL DEFAULT '0', `assignedTo` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'GUID of admin to whom ticket is assigned', `comment` text NOT NULL, PRIMARY KEY (`ticketId`))
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=40198
...
SELECT ticketId, playerGuid, bugNote, ticketCreateTime, mapId, posX, posY, posZ, orientation, closedBy, assignedTo, comment FROM ticket_bug
...
CREATE TABLE `research_digsite_finds` ( `guid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Global Unique Identifier', `digsiteId` int(11) NOT NULL, `goEntry` int(11) NOT NULL, `position_x` float NOT NULL DEFAULT '0', `position_y` float NOT NULL DEFAULT '0', `position_z` float NOT NULL DEFAULT '0', PRIMARY KEY (`guid`))
...
SELECT id, entry, owner, modelid, level, exp, Reactstate, slot, name, renamed, curhealth, curmana, abdata, savetime, CreatedBySpell, PetType FROM character_pet WHERE owner = ? AND (slot = ? OR slot > ?) 
...
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =33669
SELECT Id, MarketID, SellerID, ItemEntry, Quantity, MinBid, Duration, Chance FROM blackmarket_template
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=37865
...
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =19662
CREATE TABLE `ticket_suggest` ( `ticketId` int(10) unsigned NOT NULL, `playerGuid` bigint(20) unsigned NOT NULL, `suggestNote` text NOT NULL, `ticketCreateTime` int(10) unsigned NOT NULL DEFAULT '0', `mapId` smallint(5) unsigned NOT NULL DEFAULT '0', `posX` float NOT NULL DEFAULT '0', `posY` float NOT NULL DEFAULT '0', `posZ` float NOT NULL DEFAULT '0', `orientation` float NOT NULL DEFAULT '0', `closedBy` bigint(20) NOT NULL DEFAULT '0', `assignedTo` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'GUID of admin to whom ticket is assigned', `comment` text NOT NULL, PRIMARY KEY (`ticketId`))
...
SELECT auctionId, templateId, startTime, currentBidder, currentBid, minIncrement, numBids FROM blackmarket_auctions
...
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =21485
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=70452
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =19663
UPDATE spell_proc_event SET SpellFamilyMask1 = 0x00000006  WHERE entry IN (14186, 14190, 14193, 14194, 14195)
CREATE TABLE `character_research_projects` ( `guid` int(11) NOT NULL COMMENT 'Global Unique Identifier', `projectId` int(11) NOT NULL, PRIMARY KEY (`guid`,`projectId`))
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=64899
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=73350
...
UPDATE creature_template SET faction_A=91, faction_H=91, unit_class=8  WHERE entry=510
...
UPDATE creature_template SET faction_A=14, faction_H=14, unit_class=1  WHERE entry=1964
...
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =5519
SELECT ticketId, playerGuid, suggestNote, ticketCreateTime, mapId, posX, posY, posZ, orientation, closedBy, assignedTo, comment FROM ticket_suggest
...
INSERT INTO spell_script_names VALUES (12880, 'spell_warr_raging_blow_proc')
...
SELECT id, entry, owner, modelid, level, exp, Reactstate, slot, name, renamed, curhealth, curmana, abdata, savetime, CreatedBySpell, PetType FROM character_pet WHERE owner = ? AND id = ?
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=63957
...
UPDATE blackmarket_auctions SET currentBidder = ?, currentBid = ?, minIncrement = ?, numBids = ?  WHERE auctionId = ?
...
CREATE TABLE `research_project_requirements` ( `projectId` int(11) NOT NULL, `requiredSkillValue` int(11) NOT NULL DEFAULT '0', `chance` float NOT NULL DEFAULT '0', PRIMARY KEY (`projectId`))
...
SELECT currency, week_count, total_count, season_count, flags FROM character_currency WHERE guid = ?
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=61827
...
CREATE TABLE `blackmarket_template` ( `Id` int(10) unsigned NOT NULL DEFAULT '0', `MarketId` int(10) unsigned NOT NULL DEFAULT '0', `SellerID` int(10) unsigned NOT NULL DEFAULT '0', `ItemEntry` int(10) unsigned NOT NULL DEFAULT '0', `Quantity` int(10) unsigned NOT NULL DEFAULT '0', `MinBid` INT(10) NOT NULL DEFAULT '0', `Duration` int(10) unsigned NOT NULL DEFAULT '0', `Chance` FLOAT DEFAULT '0', PRIMARY KEY (`Id`))
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =2687
...
CREATE TABLE `uptime` ( `realmid` int(10) unsigned NOT NULL, `starttime` int(10) unsigned NOT NULL DEFAULT '0', `uptime` int(10) unsigned NOT NULL DEFAULT '0', `maxplayers` smallint(5) unsigned NOT NULL DEFAULT '0', `revision` varchar(255) NOT NULL DEFAULT 'SkyFire', PRIMARY KEY (`realmid`,`starttime`))
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =43710
...
UPDATE npc_vendor SET incrtime = 3600  WHERE entry =4168
SELECT id, creator, title, description, type, dungeon, eventtime, flags FROM calendar_events
...
SELECT id, entry, owner, modelid, level, exp, Reactstate, slot, name, renamed, curhealth, curmana, abdata, savetime, CreatedBySpell, PetType FROM character_pet WHERE owner = ? AND entry = ? AND (slot = ? OR slot > ?)
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=68659
...
UPDATE creature_template SET faction_A=188, faction_H=188, unit_class=1  WHERE entry=71199
