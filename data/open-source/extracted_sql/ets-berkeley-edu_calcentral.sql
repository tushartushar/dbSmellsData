...
CREATE TABLE links_user_roles ( link_id integer, user_role_id integer)
...
CREATE TABLE link_sections ( id integer NOT NULL, link_root_cat_id integer, link_top_cat_id integer, link_sub_cat_id integer, created_at timestamp without time zone NOT NULL, updated_at timestamp without time zone NOT NULL)
...
CREATE TABLE user_auths ( id integer NOT NULL, uid character varying(255) NOT NULL, is_superuser boolean DEFAULT false NOT NULL, active boolean DEFAULT false NOT NULL, created_at timestamp without time zone NOT NULL, updated_at timestamp without time zone NOT NULL, is_author boolean DEFAULT false NOT NULL, is_viewer boolean DEFAULT false NOT NULL)
...
CREATE INDEX index_oec_course_codes_on_dept_code ON oec_course_codes 
...
CREATE INDEX index_summer_sub_terms_on_year_and_sub_term_code ON summer_sub_terms 
...
CREATE TABLE links ( id integer NOT NULL, name character varying(255), url character varying(255), description character varying(255), published boolean DEFAULT true, created_at timestamp without time zone NOT NULL, updated_at timestamp without time zone NOT NULL)
...
CREATE TABLE canvas_site_mailing_list_members ( id integer NOT NULL, mailing_list_id integer NOT NULL, first_name character varying(255), last_name character varying(255), email_address character varying(255) NOT NULL, can_send boolean DEFAULT false NOT NULL, created_at timestamp without time zone, updated_at timestamp without time zone)
...
CREATE TABLE link_categories_link_sections ( link_category_id integer, link_section_id integer)
...
CREATE TABLE link_categories ( id integer NOT NULL, name character varying(255) NOT NULL, slug character varying(255) NOT NULL, root_level boolean DEFAULT false, created_at timestamp without time zone NOT NULL, updated_at timestamp without time zone NOT NULL)
...
CREATE TABLE link_sections_links ( link_section_id integer, link_id integer)
...
CREATE TABLE oec_course_codes ( id integer NOT NULL, dept_name character varying(255) NOT NULL, catalog_id character varying(255) NOT NULL, dept_code character varying(255) NOT NULL, include_in_oec boolean NOT NULL, created_at timestamp without time zone, updated_at timestamp without time zone)
...
CREATE INDEX index_service_alerts_on_display_and_created_at ON service_alerts 
...
CREATE TABLE user_roles ( id integer NOT NULL, name character varying(255), slug character varying(255))
INSERT INTO links_user_roles VALUES (1745, 2)
CREATE TABLE canvas_site_mailing_lists ( id integer NOT NULL, canvas_site_id character varying(255), canvas_site_name character varying(255), list_name character varying(255), state character varying(255), populated_at timestamp without time zone, created_at timestamp without time zone, updated_at timestamp without time zone, members_count integer, populate_add_errors integer, populate_remove_errors integer, type character varying(255))
...
CREATE TABLE fin_aid_years ( id integer NOT NULL, current_year integer NOT NULL, upcoming_start_date date NOT NULL, created_at timestamp without time zone, updated_at timestamp without time zone)
...
CREATE TABLE service_alerts ( id integer NOT NULL, title character varying(255) NOT NULL, snippet text, body text NOT NULL, publication_date timestamp without time zone NOT NULL, display boolean DEFAULT false NOT NULL, created_at timestamp without time zone, updated_at timestamp without time zone)
