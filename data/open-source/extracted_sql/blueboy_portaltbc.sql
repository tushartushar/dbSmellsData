...
CREATE TABLE `db_version` ( `version` varchar(120) DEFAULT NULL, `creature_ai_version` varchar(120) DEFAULT NULL, `required_s2332_01_mangos_more_spell_data` bit(1) DEFAULT NULL)
...
CREATE TABLE `character_db_version` ( `required_s2333_01_characters_reset_talents` bit(1) DEFAULT NULL)
