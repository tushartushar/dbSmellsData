...
CREATE TABLE `db_version` ( `version` varchar(120) DEFAULT NULL, `creature_ai_version` varchar(120) DEFAULT NULL, `required_s2343_01_mangos_quest_template` bit(1) DEFAULT NULL)
...
CREATE TABLE `character_db_version` ( `required_s2337_01_characters_weekly_quests` bit(1) DEFAULT NULL)
